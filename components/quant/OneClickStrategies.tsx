...
export function OneClickStrategies({ onSelect, onActivate }: OneClickStrategiesProps) {
  ...
  return (
    <div className="space-y-3">
      <p className="text-sm text-white/55">Select a strategy, customize parameters, backtest, then activate</p>
      {TEMPLATES.map((t, i) => {
        ...
        return (
          <motion.div
            ...
            className={`card transition-all ${isExpanded ? 'border-[#34EAB9]/40' : 'hover:border-white/[0.12]'}`}
          >
            <button
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white/55 text-xs leading-relaxed">{t.description}</p>
                </div>
                <ChevronDown size={16} className={`text-white/55 transition-transform mt-1 ${isExpanded ? 'rotate-180' : ''}`} />
              </div>
            </button>
              ...
              {isExpanded && (
                ...
                >
                  <div className="px-4 pb-4 space-y-3">
                    ...
                    <p className="text-xs text-white/55 uppercase tracking-wider">Parameters</p>
                    ...
                    <div className="flex gap-2 pt-1">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded text-sm font-medium bg-[#0F1A1E] border border-white/[0.12] hover:border-[#34EAB9] transition-colors disabled:opacity-50"
                      >
                        <Play size={14} />
                      ...
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded text-sm font-semibold bg-[#34EAB9] text-[#0F1A1E]"
                      >
                        <Zap size={14} />
                        Activate
                      </button>
